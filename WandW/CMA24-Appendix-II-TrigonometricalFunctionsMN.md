...
The continuity of \\(\log z\\) (when \\(z \neq 0\\)) follows from [&#167;A.31](CMA24-Appendix-I-LogrithmAndExponential.html#a.31thecontinuityofthelogarithm.) and [&#167;A.522](CMA24-Appendix-II-TrigonometricalFunctionsMN.html#a.522thecontinuityoftheargumentofacomplexvariable.), since \\(\left|\, z \,\right|\\) is a continuous function of \\(z\\). 
