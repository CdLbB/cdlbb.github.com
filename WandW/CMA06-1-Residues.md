...
[^circleexists,+3]: The existence of such a circle is
...
#####6.222 Jordan's lemma.[^jordan,-1] [6.222jordanslemma.]#####

[^jordan,-1]: Jordan, [*Cours d'Analyse*, **ii.** (1894)](https://archive.org/details/coursdanalysede02jordgoog), pp. 285, 286.
...
<p><a onClick="showIt('navcauchy');hideIt('navfront');hideIt('navprocesses');hideIt('navtranscendental');hideIt('navback');showIt('navfixedrightlist');hideIt('navfixedrightempty');" style="float: left;">&#x25A4;</a> <a href="CMA06-2-CauchysIntegral.html" style="float: right;">&#x25B6;</a></p>
</div>
