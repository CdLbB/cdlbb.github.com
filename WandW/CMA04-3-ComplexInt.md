...
analogue of de la Vallée Poussin's test for uniformity of convergence. The 
...
:C. J. de la Vallée Poussin (Louvain and Paris, 1914), [*Cours d'Analyse Infinitésimale*](https://archive.org/details/danalyseinfinitesi01pousrich),  Ch. **vi.**
...
<li class="part"><a>PROCESSES OF ANALYSIS</a>
  <ul >
    ...
    <li><a href="CMA02-1-Limits.html">The Theory of Convergence</a></li>
     ...
     <li class="notdone"><a href="CMA05-1-CauchysTheorem.html">The Properties of Analytic Functions</a></li>
...
<p><a onClick="showIt('navint');hideIt('navfront');hideIt('navprocesses');hideIt('navtranscendental');hideIt('navback');showIt('navfixedrightlist');hideIt('navfixedrightempty');" style="float: left;">&#x25A4;</a> <a href="CMA05-1-CauchysTheorem.html" style="float: right;">&#x25B6;</a></p>
</div>

<div  id="navfixedrightlist" class="fixedBright" style="visibility: hidden;">
<p><a onClick="hideIt('navint');hideIt('navfront');hideIt('navprocesses');hideIt('navtranscendental');hideIt('navback');hideIt('navfixedrightlist');showIt('navfixedrightempty');" style="float: left;">&#x25A2;</a> <a href="CMA05-1-CauchysTheorem.html" style="float: right;">&#x25B6;	</a></p>
</div>